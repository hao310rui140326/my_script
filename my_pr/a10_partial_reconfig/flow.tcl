...
proc synthesize_persona_impl {synth_rev} {
	...
	execute_module -dont_export_assignments -tool cdb -args "--export_partition root_partition --snapshot synthesized --file $synth_rev.qdb"
...
proc import_blocks_for_pr_revision {impl_rev} {
    ...
    execute_module -dont_export_assignments -tool cdb -args "--import_partition root_partition --file $BASE_REVISION_NAME.qdb"
	...
	dict for {block_name synth_rev} [dict get $IMPL_REV_BLOCK_IMPORT_MAP $impl_rev] {
		...
		execute_module -dont_export_assignments -tool cdb -args "--import_partition $block_name --file $synth_rev.qdb"
	}
...
proc compile_base_revision {} {
    ...
    execute_module -dont_export_assignments -tool cdb -args "--export_partition root_partition --snapshot final --file $BASE_REVISION_NAME.qdb --exclude_pr_subblocks"
